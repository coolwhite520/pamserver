...
MIDDLEWARE = [
    ...
    'pamserver.middleware.TimezoneMiddleware',
    'pamserver.middleware.DemoMiddleware',
    'pamserver.middleware.RequestMiddleware',
    'pamserver.middleware.RefererCheckMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pamserver.context_processor.jumpserver_processor',
...
WSGI_APPLICATION = 'pamserver.wsgi.application'
...
SESSION_ENGINE = 'pamserver.rewriting.session'
SESSION_REDIS = {
