...
SWAGGER_SETTINGS = {
    'DEFAULT_AUTO_SCHEMA_CLASS': 'pamserver.views.swagger.CustomSwaggerAutoSchema',
    ...
    'DEFAULT_INFO': 'pamserver.views.swagger.api_info',
}
...
ASGI_APPLICATION = 'pamserver.routing.application'
