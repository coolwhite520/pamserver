...
class AccessKeySerializer(serializers.Serializer):
    ...
    access_key_id = serializers.CharField(
        max_length=128, required=False, write_only=True, label=_('AccessKey ID')
    )
    access_key_secret = serializers.CharField(
        max_length=128, required=False, write_only=True, label=_('AccessKey Secret')
    )
...
class UsernamePasswordSerializer(serializers.Serializer):
    ...
    password = serializers.CharField(
        max_length=128, required=False, allow_blank=True, write_only=True, label=_('Password')
    )
...
class AzureAttrsSerializer(serializers.Serializer):
    ...
    client_id = serializers.CharField(
        max_length=128, required=False, write_only=True, label=_('Client ID')
    )
    client_secret = serializers.CharField(
        max_length=128, required=False, write_only=True, label=_('Client Secret')
    )
    tenant_id = serializers.CharField(
        max_length=128, required=False, write_only=True, label=_('Tenant ID')
    )
    subscription_id = serializers.CharField(
        max_length=128, required=False, write_only=True, label=_('Subscription ID')
    )
...
class HuaweiPrivateAttrsSerializer(serializers.Serializer):
    ...
    sc_password = serializers.CharField(
        max_length=128, required=True, write_only=True, label=f"SC {_('Password')}"
    )
    ...
    oc_password = serializers.CharField(
        max_length=128, required=True, write_only=True, label=f"OC {_('Password')}"
    )
