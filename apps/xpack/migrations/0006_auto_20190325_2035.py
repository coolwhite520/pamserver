    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password_rules', common.fields.model.JsonDictCharField(default={'length': 20}, max_length=2048, verbose_name='Password rules')),
                ('password', common.fields.model.EncryptCharField(blank=True, max_length=2048, null=True, verbose_name='Password')),
                ('private_key', common.fields.model.EncryptTextField(blank=True, max_length=4096, null=True, validators=[assets.models.utils.private_key_validator], verbose_name='SSH private key')),
                ('public_key', common.fields.model.EncryptTextField(blank=True, max_length=4096, null=True, verbose_name='SSH public key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_snapshot', common.fields.model.JsonDictCharField(blank=True, max_length=4096, null=True, verbose_name='Change auth plan snapshot')),
                ('password', common.fields.model.EncryptCharField(blank=True, max_length=2048, null=True, verbose_name='Password')),
                ('public_key', common.fields.model.EncryptTextField(blank=True, max_length=4096, null=True, verbose_name='SSH public key')),
                ('private_key', common.fields.model.EncryptTextField(blank=True, max_length=4096, null=True, validators=[assets.models.utils.private_key_validator], verbose_name='SSH private key')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
